(function($) {
    $.fn.jquizzy = function(settings) {
        ...
        answers = [],
        introFob = '	<div class="intro-container slide-container"><a class="nav-start" href="#">请认真完成，准备好了吗？<br/><br/><span><img src="'+config.startImg+'"></span></a></div>	',
        ...
        function judgeSkills(score,userAnswer) {
            var returnString;
            ...
            $.ajax({
            	type:'POST',
            	url:"setchoicescore",
            	data:{"homeworkid":homeworkid,"score":score,"userAnswer":userAnswer},
            	async:false,
            	dataType:"json",
        ...
        superContainer.find('.final').click(function() {
            ...
            resultSet = '<h2 class="qTitle">' + judgeSkills(score,userAnswer) + '<br/> 您的分数： ' + score + '</h2>' + shareButton + '<div class="jquizzy-clear"></div>' + resultSet + '<div class="jquizzy-clear"></div>';
