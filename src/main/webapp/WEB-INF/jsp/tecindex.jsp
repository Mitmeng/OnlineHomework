		...
		<div class="sidebar-left">
            ...
            <div class="sidebar-left-info">
                <ul class="nav nav-pills nav-stacked side-navigation" >
                    ...
                    <li class="menu-list">
                        <a href="javascript:;" ><i class="fa fa-book"></i>  <span>课程管理</span></a>
                        <ul class="child-list" >                            
                       		<li><a href="courseslist" target="iframecontent">我的课程</a></li>
                       		<li><a href="elecoustulist" target="iframecontent">选课情况</a></li>                        	
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="menu-list">
                    	<a href="javascript:;"><i class="fa fa-plus-square"></i> <span>新增作业  </span></a>
                       <ul class="child-list">
                       		<li><a href="addhomeworklist" target="iframecontent"> 添加套题</a></li> 
                            <li><a href="addquerstions?homeworktype=1" target="iframecontent"> 选择题</a></li>
                            <li><a href="addquerstions?homeworktype=2" target="iframecontent"> 填空题</a></li>
                            <li><a href="addquerstions?homeworktype=3" target="iframecontent"> 编程题</a></li>
                            <li><a href="addquerstions?homeworktype=4" target="iframecontent"> 简答题</a></li>
                        </ul>
                    </li>

                    <li class="menu-list">
                    	<a href="javascript:;"><i class="fa fa-file-text"></i> <span>批改作业</span></a>
                        <ul class="child-list">
                            <li><a href="quickcorrectfour?homeworktype=2&flag=1" target="iframecontent"> 填空题</a></li>
                            <li><a href="quickcorrectfour?homeworktype=3&flag=1" target="iframecontent"> 编程题</a></li>
                            <li><a href="quickcorrectfour?homeworktype=4&flag=1" target="iframecontent"> 简答题</a></li>
                        </ul>
                    </li>

                    <li class="menu-list">
                    	<a href=""><i class="fa fa-folder-open-o"></i> <span>作业管理</span></a>
                        <ul class="child-list">
                        	<li><a href="allhomework" target="iframecontent"> 全部作业</a></li>
                            <li><a href="homeworkmanager?homeworktype=1" target="iframecontent"> 学生作业-选择题</a></li>
                            <li><a href="homeworkmanager?homeworktype=2" target="iframecontent"> 学生作业-填空题</a></li>
                            <li><a href="homeworkmanager?homeworktype=3" target="iframecontent"> 学生作业-编程题</a></li>
                            <li><a href="homeworkmanager?homeworktype=4" target="iframecontent"> 学生作业-简答题</a></li>
                        </ul>
                    </li>
                    <li>
                        <h3 class="navigation-title">分析</h3>
                    </li>

                    <li class="menu-list">
                    	<a href=""><i class="fa fa-bar-chart-o"></i> <span>统计分析</span></a>
                         <ul class="child-list">
                            <li><a href="courseAnalysis" target="iframecontent"> 提交情况</a></li>
                            <li><a href="scoreAnalysis" target="iframecontent"> 成绩统计</a></li>
                        </ul>
                    </li>
                </ul>
                <!--sidebar nav end-->                
        ...
        <div class="body-content">
			   ...
			   <div id="hsDiv" style="display:none;">  
				...
				<div id="overDiv" style="display:none;"></div>  
	            	<iframe src="courseslist" name="iframecontent"  style="padding-bottom:0px;background: #f3f3f3;min-height: 900px;width: 100%;position: relative;" frameborder="0" scrolling="auto"></iframe>
	            	<!--
	                	作者：offline
	                	时间：2018-04-15
	                	描述：iframe显示的地方
