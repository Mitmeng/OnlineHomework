...
<div class="panel panel-default" padding="">
	<div class="panel-body">
		<form class="form-inline" action="quickcorrectfour?homeworktype=4&flag=2" method="post">
  		...
  		<div class="panel-group m-bot20" id="accordion">
		    <div class="panel panel-default">
		        ...
		        <div id="collapseOne" class="panel-collapse collapse in">
		            <div class="panel-body">
		             <p style="text-indent:2em;"> ${homework.content }</p>
		            </div>
		        </div>
		    </div>
		</div>
	...
	<div class="col-md-6">
       <div class="panel">
          <div class="panel-heading head-border">
              ${itemt.stuid }-By-${itemt.homeworktitle }
...
<script type="text/javascript">
	...
	function changeMe(){  
        ...
        $.post("quickfourcourse",{"courseid":courseid,"homeworktype":4},function(msg){  
                console.log(msg); 
