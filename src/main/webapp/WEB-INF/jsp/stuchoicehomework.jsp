...
<div class="da-panel-widget">
	<h4>${stuhomework.stuid }---${stuhomework.homeworktitle }</h4>
	<c:forEach items="${lChoices}" var="itemt" varStatus="status">
	<div class="da-panel-widget">
	    <p style="font-size:14px;padding:7px">第${status.count}题. ${itemt.question }</p>
	    <c:if test="${itemt.answera!=null }">
	    	<c:if test="${itemt.correctanswer==1&&stuanswer[status.count-1]==1 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项A&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answera }</p>
	    	</c:if>
	    	<c:if test="${itemt.correctanswer==1&&stuanswer[status.count-1]!=1 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项A&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answera }</p>
	    	</c:if>
	    ...
	    <c:if test="${itemt.answerb!=null }">
	    	<c:if test="${itemt.correctanswer==2&&stuanswer[status.count-1]==2 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项B&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerb }</p>
	    	</c:if>
	    	<c:if test="${itemt.correctanswer==2&&stuanswer[status.count-1]!=2 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项B&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerb }</p>
	    	</c:if>
	    ...
	    <c:if test="${itemt.answerc!=null }">
	    	<c:if test="${itemt.correctanswer==3&&stuanswer[status.count-1]==3 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项C&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerc }</p>
	    	</c:if>
	    	<c:if test="${itemt.correctanswer==3&&stuanswer[status.count-1]!=3 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项C&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerc }</p>
	    	</c:if>
	    ...
	    <c:if test="${itemt.answerd!=null }">
	    	<c:if test="${itemt.correctanswer==4&&stuanswer[status.count-1]==4 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项D&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerd }</p>
	    	</c:if>
	    	<c:if test="${itemt.correctanswer==4&&stuanswer[status.count-1]!=4 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项D&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerd }</p>
	    	</c:if>
	    ...
	    <c:if test="${itemt.answere!=null}">
	    	<c:if test="${itemt.correctanswer==5&&stuanswer[status.count-1]==5 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项E&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answere }</p>
	    	</c:if>
	    	<c:if test="${itemt.correctanswer==5&&stuanswer[status.count-1]!=5 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项E&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answere }</p>
	    	</c:if>
	    ...
	    <c:if test="${itemt.answerf!=null }">
	    	<c:if test="${itemt.correctanswer==6&&stuanswer[status.count-1]==6 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项F&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerf }</p>
	    	</c:if>
	    	<c:if test="${itemt.correctanswer==6&&stuanswer[status.count-1]!=6 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项F&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerf }</p>
	    	</c:if>
	    ...
	    <c:if test="${itemt.answerg!=null }">
	    	<c:if test="${itemt.correctanswer==7&&stuanswer[status.count-1]==7 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项G&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerg }</p>
	    	</c:if>
	    	<c:if test="${itemt.correctanswer==7&&stuanswer[status.count-1]!=7 }">
	    		<p style="padding:3px;text-indent:5em;margin-bottom:3px;color:green;">选项G&nbsp;&nbsp; &nbsp;&nbsp;${itemt.answerg }</p>
	    	</c:if>
