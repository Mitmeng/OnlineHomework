...
<div style="padding: 15px;font-size: 14px;">
	<form class="form-inline" action="homeworkmanager?homeworktype=3" method="post">
			 ...
			 <div id="da-content-area">
					...
					<div class="da-panel collapsible">
				        ...
				        <div class="da-panel-content">
				            <table id="da-ex-datatable-numberpaging" class="da-table">
				                <thead>
				                    <tr>
				                        <th><a href="javascript:;" onclick="batchDeletes()"><img src="img/icons/cross.png"  /></a></a></th>
				                        <th>学号</th>
				                        <th>提交状态</th>
				                        <th>分数</th>
				                        <th></th>
				                ...
				                <tbody>
				                	<c:forEach items="${stuhomeworklist}" var="itemt">
				                		<tr>
					                        ...
					                        <td>
					                        	<c:if test="${itemt.submits==1 }">
					                        		<a href="stuhomeworkdetail?stuhomeworkid=${itemt.id }#iframet" target="iframet" ><img src="img/icons/magnifier.png"  /></a>
				...
				<div class="grid_1">
                 	<div class="da-panel">
                     	<div class="da-panel-header">
                         	<span class="da-panel-title">
                                 <img src="img/icons/text_signature.png"  alt="Panel" />
                                 题目--${homework.title }
                             </span>
                         </div>
				...
				<div class="grid_4">
				<iframe src="" name="iframet" id="iframet" style="padding-bottom:0px;background: #f3f3f3;min-height: 600px;width: 100%;position: relative;" frameborder="0" scrolling="auto">
				</iframe>
				    <!--<c:forEach items="${stuhomeworklists}" var="itee">
					    <c:if test="${itee.submits==1 }">
						    <div class="grid_2">
					        	<div class="da-panel collapsible collapsed">
					            	<div class="da-panel-header">
					                	<span class="da-panel-title">
					                        <img src="img/icons/computer_imac.png"  alt="Panel" />
					                        ${itee.stuid }
					                    </span>
					                </div>
					                <div class="da-panel-content with-padding">
					                	<div class="grid_4">
					                		...
					                		<p>The following is a code block, highlighted using Google Prettify 
				        		by using SyntaxHighlighter plugin https://github.com/balupton/jquery-syntaxhighlighter</p>
